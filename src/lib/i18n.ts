...
const pt: Dict = {
  ...
  "timer.progress": "tempo decorrido",
  "timer.windowopens": "abre a janela",
  ...
  "stats.inwindow.hint": "Channels na janela de spawn ou com boss vivo agora",

  "tomb.marked": "Lápide marcada",
  "tomb.unmarked": "Sem lápide marcada",
  ...
  "report.tomb.time": "Hora que aparece na lápide",
  "report.tomb.time.hint":
    "A lápide mostra a hora da morte. Se conseguir ler, digite aqui — vira um timer exato.",
  "report.tomb.send": "Enviar lápide",
  "report.tomb.skip": "Não consegui ler a hora",
...
const en: Dict = {
  ...
  "stats.contributors": "Ranking",
  "stats.inwindow.hint": "Channels inside the spawn window or confirmed alive right now",

  "tomb.marked": "Tombstone pinned",
  "tomb.unmarked": "Tombstone not pinned",
  ...
  "report.tomb.time": "Time shown on the tombstone",
  "report.tomb.time.hint":
    "The tombstone shows the death time. If you can read it, type it here — that gives an exact timer.",
  "report.tomb.send": "Send tombstone",
  "report.tomb.skip": "Could not read the time",
